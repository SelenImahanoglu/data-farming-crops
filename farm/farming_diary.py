...
from farm.rice import Rice # Bunu eklemeyi unutma!
...
print(f"The corn crop is {'not ' if not corn.ripe() else ''}ripe")
...
print(f"The rice crop is {'not ' if not rice.ripe() else ''}ripe")
